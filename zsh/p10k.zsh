# Generated by Powerlevel10k configuration wizard on 2021-08-26 at 13:49 KST.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%F{$yellow}%n%f@%m%f"
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_CONTENT_EXPANSION=' Took %B${P9K_CONTENT} ⏱ '
